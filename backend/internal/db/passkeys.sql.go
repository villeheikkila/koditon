...
func (q *Queries) CountActivePasskeysByUserID(ctx context.Context, userUuid pgtype.UUID) (*int64, error) {
...
type CreatePasskeyParams struct {
	...
	UserPasskeyAaguid             pgtype.UUID        `json:"user_passkey_aaguid"`
	...
	UserPasskeyLastUsedAt         pgtype.Timestamptz `json:"user_passkey_last_used_at"`
}
...
type CreatePasskeyRow struct {
	...
	UserPasskeyRevokedAt          pgtype.Timestamptz `json:"user_passkey_revoked_at"`
}
...
func (q *Queries) ListPasskeysByUserID(ctx context.Context, userUuid pgtype.UUID) ([]ListPasskeysByUserIDRow, error) {
...
target as (
  ...
  from locked
  where user_passkey_credential_id_b64url = $2
),
updated as (
...
func (q *Queries) RevokePasskeyByCredentialB64ForUser(ctx context.Context, arg RevokePasskeyByCredentialB64ForUserParams) (string, error) {
	row := q.db.QueryRow(ctx, revokePasskeyByCredentialB64ForUser, arg.UserUuid, arg.UserPasskeyCredentialIDB64url)
	var outcome string
