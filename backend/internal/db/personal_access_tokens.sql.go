...
type CreatePersonalAccessTokenParams struct {
	...
	PersonalAccessTokenExpiresAt pgtype.Timestamptz `json:"personal_access_token_expires_at"`
}
...
type CreatePersonalAccessTokenRow struct {
	...
	PersonalAccessTokenLastUsedAt pgtype.Timestamptz `json:"personal_access_token_last_used_at"`
	PersonalAccessTokenExpiresAt  pgtype.Timestamptz `json:"personal_access_token_expires_at"`
	PersonalAccessTokenRevokedAt  pgtype.Timestamptz `json:"personal_access_token_revoked_at"`
}
...
func (q *Queries) RevokePersonalAccessToken(ctx context.Context, personalAccessTokenID pgtype.UUID) error {
...
func (q *Queries) UpdatePersonalAccessTokenLastUsed(ctx context.Context, personalAccessTokenID pgtype.UUID) error {
