...
type ConsumeOAuthAuthorizationCodeRow struct {
	...
	OauthAuthorizationCodeConsumedAt          pgtype.Timestamptz `json:"oauth_authorization_code_consumed_at"`
...
type CreateOAuthAuthorizationCodeParams struct {
	...
	OauthAuthorizationCodeCodeChallenge       *string            `json:"oauth_authorization_code_code_challenge"`
	OauthAuthorizationCodeCodeChallengeMethod *string            `json:"oauth_authorization_code_code_challenge_method"`
	OauthAuthorizationCodeExpiresAt           pgtype.Timestamptz `json:"oauth_authorization_code_expires_at"`
}
...
type CreateOAuthRefreshTokenParams struct {
	...
	OauthRefreshTokenExpiresAt   pgtype.Timestamptz `json:"oauth_refresh_token_expires_at"`
	OauthRefreshTokenRotatedFrom pgtype.UUID        `json:"oauth_refresh_token_rotated_from"`
}
...
type CreateOAuthRefreshTokenRow struct {
	...
	OauthRefreshTokenRevokedAt   pgtype.Timestamptz `json:"oauth_refresh_token_revoked_at"`
	OauthRefreshTokenRotatedFrom pgtype.UUID        `json:"oauth_refresh_token_rotated_from"`
...
func (q *Queries) ListOAuthAppConnectionsByUserID(ctx context.Context, userUuid pgtype.UUID) ([]ListOAuthAppConnectionsByUserIDRow, error) {
...
func (q *Queries) RevokeAllOAuthRefreshTokensByUserID(ctx context.Context, userUuid pgtype.UUID) error {
