...
type CreateOAuthDynamicClientParams struct {
	...
	OauthDynamicClientMetadata                []byte             `json:"oauth_dynamic_client_metadata"`
	OauthDynamicClientIssuedAt                pgtype.Timestamptz `json:"oauth_dynamic_client_issued_at"`
}
...
type CreateOAuthDynamicClientRow struct {
	...
	OauthDynamicClientDisabledAt              pgtype.Timestamptz `json:"oauth_dynamic_client_disabled_at"`
