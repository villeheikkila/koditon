...
type UpdateSessionMetadataParams struct {
	DeviceSessionDeviceName          interface{} `json:"device_session_device_name"`
	DeviceSessionDeviceOs            interface{} `json:"device_session_device_os"`
	DeviceSessionDeviceModel         interface{} `json:"device_session_device_model"`
	DeviceSessionAppVersion          interface{} `json:"device_session_app_version"`
	DeviceSessionLocale              interface{} `json:"device_session_locale"`
	DeviceSessionTimeZone            interface{} `json:"device_session_time_zone"`
	DeviceSessionLocationCity        interface{} `json:"device_session_location_city"`
	DeviceSessionLocationRegion      interface{} `json:"device_session_location_region"`
	DeviceSessionLocationCountryCode interface{} `json:"device_session_location_country_code"`
	DeviceSessionLocationSource      interface{} `json:"device_session_location_source"`
	DeviceSessionUuid                uuid.UUID   `json:"device_session_uuid"`
}
