...
type GetFrontdoorBuildingAnnouncementByIDRow struct {
	...
	FrontdoorBuildingAnnouncementIdentityKey              string     `json:"frontdoor_building_announcement_identity_key"`
...
func (q *Queries) GetFrontdoorBuildingAnnouncementByID(ctx context.Context, dollar_1 *uuid.UUID) (GetFrontdoorBuildingAnnouncementByIDRow, error) {
	...
	err := row.Scan(
		...
		&i.FrontdoorBuildingAnnouncementIdentityKey,
		...
		&i.FrontdoorBuildingAnnouncementDataNormalizedAt,
		&i.FrontdoorBuildingAnnouncementDataNormalizedVersion,
	)
	return i, err
}
...
const markFrontdoorBuildingAnnouncementDataNormalized = `-- name: MarkFrontdoorBuildingAnnouncementDataNormalized :exec
UPDATE origin.frontdoor_building_announcements
SET frontdoor_building_announcement_data_normalized_at = now(),
    frontdoor_building_announcement_data_normalized_version = $1
WHERE frontdoor_building_announcement_id = $2
`
...
func (q *Queries) MarkFrontdoorBuildingAnnouncementDataNormalized(ctx context.Context, arg MarkFrontdoorBuildingAnnouncementDataNormalizedParams) error {
	_, err := q.db.Exec(ctx, markFrontdoorBuildingAnnouncementDataNormalized, arg.FrontdoorBuildingAnnouncementDataNormalizedVersion, arg.FrontdoorBuildingAnnouncementID)
	return err
}
...
func (q *Queries) UpsertFrontdoorBuildingAnnouncement(ctx context.Context, arg UpsertFrontdoorBuildingAnnouncementParams) (UpsertFrontdoorBuildingAnnouncementRow, error) {
	row := q.db.QueryRow(ctx, upsertFrontdoorBuildingAnnouncement,
		arg.FrontdoorBuildingAnnouncementIdentityKey,
