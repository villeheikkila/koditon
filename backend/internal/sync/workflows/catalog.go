...
var definitions = []Definition{
	...
	{Name: "prices_cities_init", Queue: QueuePrices, DefaultMaxAttempts: 3},
	{Name: "prices_sync", Queue: QueuePrices, DefaultMaxAttempts: 3},
	{Name: "prices_postal_code_sync", Queue: QueuePrices, DefaultMaxAttempts: 3},
	{Name: "prices_postal_code_page_sync", Queue: QueuePrices, DefaultMaxAttempts: 3},
	{Name: "prices_neighborhood_postal_code_sync", Queue: QueuePrices, DefaultMaxAttempts: 3},
	{Name: "prices_sync_all", Queue: QueuePrices, DefaultMaxAttempts: 3},
	...
	{Name: "canonical_match_sale_listing_sources_backfill", Queue: QueueCanonicalDB, DefaultMaxAttempts: 3},
	{Name: "canonical_match_sale_listing_sources_fanout", Queue: QueueCanonicalDB, DefaultMaxAttempts: 3},
	{Name: "canonical_match_sale_listing_source", Queue: QueueCanonicalDB, DefaultMaxAttempts: 3},
