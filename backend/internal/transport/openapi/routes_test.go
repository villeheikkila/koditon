...
func TestAddRoutesIncludesAddressLookup(t *testing.T) {
	...
	for _, want := range []string{"raw_transactions", "linked_to_lookup", "candidate_to_lookup", "is_matched", "matched_listing_count", "source_records", "source_candidates", "candidate_offering_id", "transactions", "link_type", "external_url_available", "reasons_summary", "canonical_id"} {
