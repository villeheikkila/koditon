...
func frontdoorAnnouncementBuilding(row db.GetFrontdoorAnnouncementUnifiedDetailRow, location Location) BuildingDetails {
	...
	return BuildingDetails{Identity: identity, Location: buildingLocation, HousingCompany: valueOrEmpty(row.FrontdoorBuildingCompanyName), EnergyClass: valueOrEmpty(row.FrontdoorBuildingEnergyCertificateCode)}
}
