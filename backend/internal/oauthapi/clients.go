...
func staticClients(webBaseURL string) (map[string]oauthClient, error) {
	...
	appClientScopes := []string{
		...
		auth.ScopeCheckInsRead,
		auth.ScopeCheckInsWrite,
		auth.ScopeCheckInCommentsWrite,
		auth.ScopeReportsWrite,
		auth.ScopeEditSuggestionsWrite,
		auth.ScopeAnalyticsWrite,
		auth.ScopeProductsWrite,
		auth.ScopeBrandsWrite,
		auth.ScopeSubBrandsWrite,
		auth.ScopeCompaniesWrite,
		auth.ScopeCategoriesWrite,
		auth.ScopeFlavorsWrite,
		auth.ScopeLogosWrite,
		auth.ScopeAdminProfileRead,
		auth.ScopeAdminProfileWrite,
		auth.ScopeAdminCheckInsRead,
		auth.ScopeAdminCheckInsWrite,
		auth.ScopeAdminCheckInCommentsRead,
		auth.ScopeAdminCheckInCommentsWrite,
		auth.ScopeAdminReportsRead,
		auth.ScopeAdminReportsWrite,
		auth.ScopeAdminEditSuggestionsRead,
		auth.ScopeAdminEditSuggestionsWrite,
		auth.ScopeAdminProductsRead,
		auth.ScopeAdminProductsWrite,
		auth.ScopeAdminBrandsRead,
		auth.ScopeAdminBrandsWrite,
		auth.ScopeAdminCompaniesRead,
		auth.ScopeAdminCompaniesWrite,
		auth.ScopeAdminSubBrandsRead,
		auth.ScopeAdminSubBrandsWrite,
	}
