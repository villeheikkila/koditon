...
SELECT
    ...
    sl.sale_listing_headline AS headline,
    sl.sale_listing_street_address AS street_address,
    ...
    sl.sale_listing_property_type_raw AS property_type_raw,
    sl.sale_listing_condition AS condition,
    sl.sale_listing_elevator,
    sl.sale_listing_energy_class AS energy_class,
    sl.sale_listing_energy_efficiency_label AS energy_efficiency_label,
    sl.sale_listing_plot_type_raw AS plot_type_raw,
    sl.sale_listing_plot_type_code AS plot_type_code,
    ...
    sl.sale_listing_parking_text AS parking_text,
    sl.sale_listing_kitchen_description_text AS kitchen_description_text,
    sl.sale_listing_bathroom_description_text AS bathroom_description_text,
    sl.sale_listing_storage_description_text AS storage_description_text,
    sl.sale_listing_floor_materials_description_text AS floor_materials_description_text,
    sl.sale_listing_wall_materials_description_text AS wall_materials_description_text,
    sl.sale_listing_balcony_description_text AS balcony_description_text,
    sl.sale_listing_sauna_description_text AS sauna_description_text,
    sl.sale_listing_views_description_text AS views_description_text,
    COALESCE(sl.sale_listing_appliances, ARRAY[]::text[]) AS appliances,
    COALESCE(sl.sale_listing_features, ARRAY[]::text[]) AS features,
    sl.sale_listing_plot_area_value,
    sl.sale_listing_services_text AS services_text,
    sl.sale_listing_transport_text AS transport_text,
    sl.sale_listing_previous_asking_price,
    sl.sale_listing_previous_debt_free_price,
    sl.sale_listing_new_development,
    sl.sale_listing_description_text AS description_text,
    ...
    sl.sale_listing_housing_company_name AS housing_company_name,
    sl.sale_listing_housing_company_business_id AS housing_company_business_id,
    sl.sale_listing_building_material AS building_material,
    sl.sale_listing_heating_system AS heating_system,
    sl.sale_listing_roof_type AS roof_type,
    sl.sale_listing_roof_material AS roof_material,
    sl.sale_listing_car_storage_text AS car_storage_text,
    sl.sale_listing_building_description_text AS building_description_text,
    sl.sale_listing_building_other_info_text AS building_other_info_text
FROM public.property_source_offerings sl
LEFT JOIN origin.frontdoor_ads fa ON fa.frontdoor_ad_id = sl.frontdoor_ad_id
LEFT JOIN origin.shortcut_ads sa ON sa.shortcut_ad_id = sl.shortcut_ad_id
WHERE sl.sale_listing_id = @sale_listing_id
