...
ADD COLUMN sale_listing_price_per_m2 double precision,
ADD COLUMN sale_listing_debt_free_price bigint,
ADD COLUMN sale_listing_debt_share_amount bigint,
ADD COLUMN sale_listing_rooms_count integer,
ADD COLUMN sale_listing_floor_level integer,
ADD COLUMN sale_listing_total_floors integer,
ADD COLUMN sale_listing_build_year integer,
ADD COLUMN sale_listing_condition text,
ADD COLUMN sale_listing_energy_class text,
ADD COLUMN sale_listing_description_text text;
CREATE INDEX idx_sale_listings_rooms_count ON public.sale_listings (sale_listing_rooms_count);
CREATE INDEX idx_sale_listings_floor_level ON public.sale_listings (sale_listing_floor_level);
CREATE INDEX idx_sale_listings_build_year ON public.sale_listings (sale_listing_build_year);
CREATE INDEX idx_sale_listings_price_per_m2 ON public.sale_listings (sale_listing_price_per_m2);
...
BEGIN
    ...
    SET
        ...
        sale_listing_build_year = COALESCE(fba.frontdoor_building_announcement_construction_finished_year, NEW.frontdoor_building_build_year, NEW.frontdoor_building_construction_end_year),
        sale_listing_energy_class = NEW.frontdoor_building_energy_certificate_code,
...
SET frontdoor_building_announcement_last_seen_at = frontdoor_building_announcement_last_seen_at
