...
CREATE FUNCTION public.fnc__canonical_identity_part(value text) RETURNS text
...
--
-- Name: fnc__clear_listing_dimension_targets_dirty(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__clear_listing_dimension_targets_dirty(p_sale_listing_id uuid) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_count integer := 0;
...
--
-- Name: fnc__clear_listing_dimension_targets_dirty(uuid, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__clear_listing_dimension_targets_dirty(p_sale_listing_id uuid, p_expected_dirty_at timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_count integer := 0;
...
--
-- Name: fnc__clear_property_dimension_target_dirty(text, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__clear_property_dimension_target_dirty(p_target_type text, p_target_id uuid) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_count integer;
...
--
-- Name: fnc__clear_property_dimension_target_dirty(text, uuid, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__clear_property_dimension_target_dirty(p_target_type text, p_target_id uuid, p_expected_dirty_at timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_count integer;
...
--
-- Name: fnc__legacy_property_dimension_claim_scope(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__legacy_property_dimension_claim_scope(p_target_type text) RETURNS text
    LANGUAGE sql IMMUTABLE
    AS $$
SELECT CASE
...
--
-- Name: fnc__legacy_property_dimension_key(text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__legacy_property_dimension_key(p_section text, p_key text) RETURNS text
    LANGUAGE sql IMMUTABLE
    AS $$
...
--
-- Name: fnc__legacy_property_dimension_target_type(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__legacy_property_dimension_target_type(p_target_type text) RETURNS text
    LANGUAGE sql IMMUTABLE
    AS $$
...
--
-- Name: fnc__legacy_property_dimension_value(text, text, double precision, boolean, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__legacy_property_dimension_value(p_value_kind text, p_value_text text, p_value_number double precision, p_value_bool boolean, p_value_json jsonb) RETURNS jsonb
    LANGUAGE sql IMMUTABLE
    AS $$
...
--
-- Name: fnc__legacy_property_dimension_value_kind(text, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__legacy_property_dimension_value_kind(p_value_kind text, p_value_json jsonb) RETURNS text
    LANGUAGE sql IMMUTABLE
    AS $$
SELECT CASE p_value_kind
...
--
-- Name: fnc__mark_property_dimension_target_dirty(text, uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__mark_property_dimension_target_dirty(p_target_type text, p_target_id uuid, p_reason text DEFAULT 'changed'::text) RETURNS integer
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: fnc__mark_property_offering_dimension_targets_dirty(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__mark_property_offering_dimension_targets_dirty(p_property_offering_id uuid, p_reason text DEFAULT 'offering_link_changed'::text) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_count integer := 0;
...
--
-- Name: fnc__mark_property_unit_dimension_targets_dirty(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__mark_property_unit_dimension_targets_dirty(p_property_unit_id uuid, p_reason text DEFAULT 'unit_link_changed'::text) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_count integer := 0;
...
--
-- Name: fnc__project_dimension_profile_for_target(text, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__project_dimension_profile_for_target(p_target_type text, p_target_id uuid) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_dimensions jsonb;
...
--
-- Name: fnc__project_listing_provider_dimension_claims(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__project_listing_provider_dimension_claims(p_sale_listing_id uuid) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_run_id uuid;
...
--
-- Name: fnc__rebuild_listing_dimension_layer(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__rebuild_listing_dimension_layer(p_sale_listing_id uuid) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: fnc__rebuild_listing_dimension_layer(uuid, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__rebuild_listing_dimension_layer(p_sale_listing_id uuid, p_expected_dirty_at timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_source_claims integer;
...
CREATE FUNCTION public.fnc__relink_physical_building_housing_company(p_physical_building_id uuid, p_target_housing_company_id uuid, p_reason text DEFAULT 'building_housing_company_relinked'::text) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: fnc__relink_property_document_offering(uuid, uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__relink_property_document_offering(p_property_document_id uuid, p_target_property_offering_id uuid, p_reason text DEFAULT 'property_document_relinked'::text) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: fnc__relink_property_unit_building(uuid, uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__relink_property_unit_building(p_property_unit_id uuid, p_target_physical_building_id uuid, p_reason text DEFAULT 'unit_building_relinked'::text) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_old_building_id uuid;
...
--
-- Name: fnc__resolve_dimension_target(text, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__resolve_dimension_target(p_target_type text, p_target_id uuid) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_values integer;
...
--
-- Name: fnc__resolve_dimension_target(text, uuid, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__resolve_dimension_target(p_target_type text, p_target_id uuid, p_expected_dirty_at timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_values integer;
...
--
-- Name: fnc__resolve_dimension_values_for_target(text, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fnc__resolve_dimension_values_for_target(p_target_type text, p_target_id uuid) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_run_id uuid;
...
CREATE FUNCTION public.fnc__sync_property_house_for_sale_listing(listing_id uuid, link_method text DEFAULT 'sync_auto'::text) RETURNS uuid
    LANGUAGE plpgsql
    AS $$
DECLARE
    house_id uuid;
